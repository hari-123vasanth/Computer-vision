...
def calculate_speed(flow, scale_factor, fps):
    ...
    """
    magnitudes = np.sqrt(flow[..., 0] ** 2 + flow[..., 1] ** 2)  # Compute magnitude of flow
...
if __name__ == "__main__":
    video_path = r"C:\Users\hp\Downloads\Computer-Vision-main\8.optical_flow\original.mp4"  # Replace with your video file
